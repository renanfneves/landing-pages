      ...
      <GraphicArticle.ContentRoot>
        ...
        >
          ...
          >
            ...
            <p className="text-sm">
              ...
              garantir que os seus móveis se mantenham frescos e limpos. A nossa
              equipa de especialistas utiliza técnicas avançadas e produtos
              ecológicos para remover sujidade, manchas e alergénios, deixando
              os seus estofos com um aspeto renovado.
            </p>
          </div>
        </button>
        <button
        ...
        >
          ...
          >
            ...
            <p className="text-sm">
              Os nossos serviços profissionais de limpeza de colchões ajudam-no
              a manter um ambiente de sono limpo e saudável. Utilizamos
              equipamento especializado e soluções de limpeza seguras para
              remover ácaros, alergénios e manchas, garantindo-lhe uma boa noite
              de sono.
            </p>
          </div>
        </button>
        ...
        >
          ...
          >
            ...
            <p className="text-sm">
              As nossas soluções de limpeza para carpetes foram concebidas para
              limpar profundamente e revitalizar os seus tapetes. Utilizamos
              equipamento poderoso e métodos eficazes de limpeza para remover
              sujidade, bactérias e odores, deixando os seus carpetes com um
              aspeto e um aroma frescos.
            </p>
          </div>
        </button>
      </GraphicArticle.ContentRoot>
